...
/** A lazy value is one that may be calculated as demand.
 * The primary implementation class is {@link Promise}, but
 * {@link Future} also implements {@code Lazy}.
 * Primitive operations (such arithmetic) require non-lazy (or "eager") value;
 ...
 * may contain lazy comonpents (for example an eager vector of lazy values).
